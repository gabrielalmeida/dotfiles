...
if [ "$OS" == 'OSX' ] && { [ "$INSTALL" == 'EVERYTHING' ] || [ "$INSTALL" == "CHOOSE" ]; } then
  ...
  if [ $(ask "Should I install hack your OSX?") == 'y' ]; then
    ...
    while true; do sudo -n true; sleep 60; kill -0 "$$" || exit; done 2>/dev/null &
      ...
      if [ "${CURRENT_PROFILE}" != "${TERM_PROFILE}" ]; then
        open "${HOME}/dotfiles/iterm2/${TERM_PROFILE}.terminal";
      ...
      open "${HOME}/dotfiles/iterm2/base16-summerfruit.light.256.itermcolors"
